...
export const DashPage = () =>{
    ...
    useEffect(
        ()=>{
           ...
           async  function f(){
               if(data==='Loading...'){
                let result = await API_GET(`http://127.0.0.1:9000/getMultipleData`);
    ...
    return (
        <div className="admin">
            ...
            <div className="multi-analytics-holder">
                ...
                <MiniAnalytics  data={data.leftClickCount?data.leftClickCount:"Loading..."} displayInfo={true} info={'Total number of left clicks on products'} header={"Total products opened"} route="/leftclicks"></MiniAnalytics>
                <MiniAnalytics data={data.rightClickCount?data.rightClickCount:"Loading..."} displayInfo={false} header={"Total products right clicked on"} route="/rightclicks"></MiniAnalytics>
